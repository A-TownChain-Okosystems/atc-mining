...
> Mining-Stack ausserhalb des Cores - der Core bleibt regel-definierend, nicht hardware-treibend.
...
```
Blockchain-Core definiert: PoW-Regeln - Difficulty -
Block-Validierung - Reward
    v
atc-mining implementiert: Hashing - Hardware (GPU/CPU/Mobile)
    +-- miner/ - algorithms/ - plugins/
    +-- mining-manager/ - pool/ - telemetry/ - dashboard/
```
...
- **Purpose:** Mining-Service (L5, Roadmap M6).
- **Scope:** Layer L5, Domain mining — atc-mining als CORE in der 23-Repo-Landschaft (AD-024/026).
- **Architecture:** Blockchain-PoW (SHA3-ATC) als Service.
- **Features:** Skelett.
